...
export const DashboardPage: React.FC = () => {
  ...
  const statCards = [
    { label: 'Active Cases', value: activeCasesCount, icon: FolderOpen, color: 'from-primary-500/20 to-primary-500/5', iconColor: 'text-primary-400', change: '+2', trend: 'up' },
    { label: 'Watched Wallets', value: watchedCount, icon: Eye, color: 'from-accent-green/20 to-accent-green/5', iconColor: 'text-accent-green', change: '+1', trend: 'up' },
    ...
    { label: 'Active Alerts', value: unreadAlertsCount, icon: Bell, color: 'from-accent-red/20 to-accent-red/5', iconColor: 'text-accent-red', change: '+3', trend: 'up' },
