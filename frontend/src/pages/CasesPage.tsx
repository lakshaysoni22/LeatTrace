...
export const CasesPage: React.FC = () => {
  ...
  const [tasksList, setTasksList] = useState([
    ...
    { id: 't-2', text: 'Validate and seal primary suspects wallet PDF report file', assignee: '@inspector.verma', done: true },
                  ...
                  <div className="space-y-4 text-xs">
                    ...
                    <form onSubmit={handleAddTask} className="flex gap-2">
                      ...
                      >
                        ...
                        <option value="@inspector.verma">@inspector.verma</option>
