...
export const SettingsPage: React.FC = () => {
  ...
  const [usersList, setUsersList] = useState([
    { id: 'usr-1', name: 'Inspector Sharma', email: 'inspector.sharma@cybercrime.gov.in', role: 'investigator', status: 'Active' },
      ...
      <div className="space-y-6">
        {activeTab === 'profile' && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Profile Card */}
            <div className="md:col-span-1 glass-card p-5 space-y-4 border-dark-700/50">
              ...
              <div className="space-y-3 text-xs">
                <div className="flex flex-col">
                  ...
                  <span className="text-xs font-semibold text-white">{user?.username || 'Inspector Sharma'}</span>
                </div>
                <div className="flex flex-col">
                  <span className="text-[10px] text-dark-500 uppercase">Email Profile</span>
                  <span className="text-xs font-semibold text-white mono">{user?.email || 'inspector.sharma@cybercrime.gov.in'}</span>
                </div>
                <div className="flex flex-col">
            ...
            <div className="md:col-span-2 space-y-6">
              ...
              <div className="glass-card p-6 space-y-4 border-dark-700/50">
                <div className="flex items-center gap-2 border-b border-dark-700/50 pb-3">
                  <FileLock2 size={16} className="text-accent-gold" />
                  <h3 className="text-sm font-bold text-white">Cryptographical Evidence Security</h3>
                </div>
                
                <p className="text-xs text-dark-300 leading-relaxed">
                  All uploads cataloged in the Evidence Locker are computed into cryptographical digests using the **SHA-256** checksum. Changes to physical files trigger forensic mismatch warnings in compliance dashboards immediately.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="glass-card p-5 border-dark-700/50 space-y-4">
              <div className="flex items-center gap-2 border-b border-dark-800 pb-3">
                ...
                <h3 className="text-sm font-bold text-white">System Service Diagnostics</h3>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs font-semibold">
                ...
                <div className="p-3 bg-dark-900 border border-dark-850 rounded-xl flex items-center justify-between">
                  <div>
                    <span className="text-[10px] text-dark-500 block uppercase">PostgreSQL Database</span>
                    <span className="text-white font-mono">Active Connection</span>
                  </div>
                  <span className="flex items-center gap-1 text-accent-green"><span className="w-1.5 h-1.5 rounded-full bg-accent-green" /> ONLINE</span>
                </div>

                <div className="p-3 bg-dark-900 border border-dark-850 rounded-xl flex items-center justify-between">
                  <div>
                    <span className="text-[10px] text-dark-500 block uppercase">Neo4j Database</span>
                    <span className="text-white font-mono">Bolt Port 7687</span>
                  </div>
                  <span className="flex items-center gap-1 text-accent-green"><span className="w-1.5 h-1.5 rounded-full bg-accent-green" /> ONLINE</span>
                </div>
                ...
                <div className="p-3 bg-dark-900 border border-dark-850 rounded-xl flex items-center justify-between">
                  <div>
                    <span className="text-[10px] text-dark-500 block uppercase">Redis Cache</span>
                    <span className="text-white font-mono">Port 6379</span>
                  </div>
                  <span className="flex items-center gap-1 text-accent-green"><span className="w-1.5 h-1.5 rounded-full bg-accent-green" /> ONLINE</span>
                </div>
                ...
                <div className="p-3 bg-dark-900 border border-dark-850 rounded-xl flex items-center justify-between">
                  <div>
                    <span className="text-[10px] text-dark-500 block uppercase">Evidence Storage Vault</span>
                    <span className="text-white font-mono">14.2 GB used of 50 GB</span>
                  </div>
