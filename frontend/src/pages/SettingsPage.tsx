...
export const SettingsPage: React.FC = () => {
  ...
  const [usersList, setUsersList] = useState([
    { id: 'usr-1', name: 'Inspector Verma', email: 'inspector.verma@cybercrime.gov.in', role: 'investigator', status: 'Active' },
              ...
              <div className="glass-card p-5 space-y-4 border-dark-700/50">
                ...
                <div className="space-y-3 text-xs">
                  <div className="flex flex-col">
                    ...
                    <span className="text-xs font-semibold text-white">{user?.username || 'Inspector Verma'}</span>
                  </div>
                  <div className="flex flex-col">
                    <span className="text-[10px] text-dark-500 uppercase">Email Profile</span>
                    <span className="text-xs font-semibold text-white mono">{user?.email || 'inspector.verma@cybercrime.gov.in'}</span>
                  </div>
                  <div className="flex flex-col">
