...
class OAuth2Server:
    ...
    def get_authorization_request(self, request_id: str) -> Optional[AuthorizationRequest]:
        ...
        if datetime.datetime.utcnow() > auth_request.expires_at:
            return None  # Expired
    ...
    def exchange_authorization_code(
        ...
        if datetime.datetime.utcnow() > auth_code.expires_at:
        ...
        # Mark code as used
        auth_code.used = True
        auth_code.used_at = datetime.datetime.utcnow()
    ...
    def refresh_access_token(
        ...
        if datetime.datetime.utcnow() > refresh_record.expires_at:
        ...
        refresh_record.last_used = datetime.datetime.utcnow()
