...
from ...infra.clickhouse import clickhouse_warehouse
...
class BlockchainService:
    def __init__(self, rpc_urls: Optional[Dict[str, str]] = None):
        ...
        self.health_status = {}
        # Tested lazily on request in get_rpc_status()
    ...
    def get_threat_intelligence(self, address: str) -> Dict[str, Any]:
        ...
        from ..sanctions.screening_engine import sanctions_screening_engine
        db = SessionLocal()
        try:
