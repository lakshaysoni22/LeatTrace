...
class APIKeyManager:
    ...
    def validate_api_key(
        ...
        # Check expiration
        if api_key.expires_at and datetime.datetime.utcnow() > api_key.expires_at:
    ...
    def rotate_api_key(self, key_id: str) -> Optional[Tuple[APIKey, APIKey]]:
        ...
        old_key.rotation_at = datetime.datetime.utcnow() + datetime.timedelta(hours=24)
...
class IPWhitelistManager:
    ...
    def is_ip_whitelisted(
        ...
        for entry in self.whitelist.values():
            ...
            if entry.expires_at and datetime.datetime.utcnow() > entry.expires_at:
                continue
