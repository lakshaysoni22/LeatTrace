...
from ...services.wallet.cluster_engine import wallet_cluster
from ...services.wallet.reputation import wallet_reputation
from ...services.blockchain.cross_chain_service import cross_chain_service
from ...services.blockchain.bridge_detector import bridge_detector
from ...services.blockchain.defi_decoder import defi_decoder
from ...services.blockchain.mixer_detector import mixer_detector
from ...services.intel.threat_feed_manager import threat_feed_manager
from ...services.risk.risk_engine import risk_engine
from ...services.intel.entity_resolution import entity_resolution
from ...services.intel.relationship_engine import relationship_engine
from ...services.blockchain.laundering_engine import laundering_engine
from ...services.risk.risk_patterns import risk_pattern_engine
...
def list_protocols(protocol_type: Optional[str] = Query(None, description="Filter by protocol type.")):
    ...
    from ...services.blockchain.protocol_registry import protocol_registry
    if protocol_type:
